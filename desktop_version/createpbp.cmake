...
#    if("${CMAKE_BUILD_TYPE}" STREQUAL "Release")
    if("${CMAKE_BUILD_TYPE}" STREQUAL "ReleaseMinSize")
        add_custom_command(
            TARGET ${ARG_TARGET}
            POST_BUILD COMMAND
            # Dont do this, wont work with PRX
    ...
    add_custom_command(
            TARGET ${ARG_TARGET}
            POST_BUILD COMMAND
            "${PACK_PBP}" "EBOOT_e.PBP" "PARAM.SFO" "${ARG_ICON_PATH}" "NULL" "${ARG_PREVIEW_PATH}"
    ...
    add_custom_command(
            TARGET ${ARG_TARGET}
            POST_BUILD COMMAND
            "${PACK_PBP}" "EBOOT_p.PBP" "PARAM.SFO" "${ARG_ICON_PATH}" "NULL" "${ARG_PREVIEW_PATH}"
